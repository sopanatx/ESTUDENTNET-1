...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>ระบบควบคุมคะแนนพฤติกกรรม</title>
        ...
        <ul class="menu-items">
          ...
          <li class="">
            <a href="email.html" class="detailed">
              <span class="title">จัดการคะแนน</span>
              <span class="details">234 New Emails</span>
            </a>
            <span class="icon-thumbnail"><i class="pg-mail"></i></span>
          </li>
          <li class="">
            <a href="social.html"><span class="title">จัดการนักเรียน</span></a>
      ...
      <div class="header ">
        ...
        <div class="">
          <div class="brand inline   m-l-10">
            <img src="assets_admin/img/logo.png" alt="logo" data-src="assets_admin/img/logo.png" data-src-retina="assets_admin/img/logo_2x.png" width="78" height="22">
          </div>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            <img width="30" height="30" data-src-retina="assets_admin/img/profiles/1x.jpg" data-src="assets_admin/img/profiles/1.jpg" alt="" src="assets_admin/img/profiles/1.jpg">
                          </div>
                          <a href="#" class="text-complete pull-left">
          ...
          <a href="#" class="search-link hidden-md-down" data-toggle="search"><i class="pg-search"></i>พิมพ์อะไรบางอย่างเพื่อ <span class="bold">ค้นหา</span></a>
        </div>
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown pull-right hidden-md-down">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <img src="assets_admin/img/profiles/avatar.jpg" alt="" data-src="assets_admin/img/profiles/avatar.jpg" data-src-retina="assets_admin/img/profiles/avatar_small2x.jpg" width="32" height="32">
              </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
              <a href="#" class="dropdown-item"><i class="pg-settings_small"></i> ตั้งค่า</a>
              <a href="#" class="dropdown-item"><i class="pg-outdent"></i> เปลี่ยนรหัสผ่าน</a>
                          ...
                          <div class="col-xs-height col-top">
                            <div class="card-header  top-left top-right">
                              <div class="card-title text-black hint-text">
                                <span class="font-montserrat fs-11 all-caps">จำนวนเจ้าหน้าที่ในระบบ <i class="fa fa-vcard"></i>
                                                    </span>
                              </div>
                        ...
                        <div class="row-xs-height ">
                          <div class="col-xs-height col-top relative">
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="p-l-20">
                                  <h3 class="no-margin p-b-5 text-white">{{$users}} คน </h3>
                      ...
                      <div class="full-height d-flex flex-column">
                        <div class="card-header ">
                          <div class="card-title text-black">
                            <span class="font-montserrat fs-11 all-caps">จำนวนนักเรียนในระบบทั้งหมด <i
	                    class="fa fa-users"></i>
	                                </span>
                          </div>
                          <div class="card-controls">
                        ...
                        <div class="p-l-20">
                          <h3 class="no-margin p-b-5 text-white"> {{$stdc}} คน</h3>
                    ...
                    <div class="widget-12 card no-border widget-loader-circle no-margin">
                      ...
                      <div class="card-block">
                        <div class="row">
                          <div class="col-sm-8">
                            <div class="p-l-5">
                              <h2 class="pull-left m-t-5 m-b-5">ข้อมูลคะแนนนักเรียน</h2>
                          ...
                          <div class="col-sm-4">
                            <div class="widget-12-search">
                              <h5 class="pull-left">ข้อมูลนักเรียนตามช่วงชั้น
                            ...
                            <div class="company-stat-boxes">
                              <div data-index="0" class="company-stat-box m-t-15 active padding-20 bg-master-lightest">
                                <div>
                                  ...
                                  <p class="company-name pull-left text-uppercase bold no-margin">
                                    <span class="fa fa-circle text-success fs-11"></span> มัธยมศึกษาตอนต้น
                                  </p> 
                                  <div class="clearfix"></div>
                                </div>
                              ...
                              <div data-index="1" class="company-stat-box m-t-15  padding-20 bg-master-lightest">
                                <div>
                                  ...
                                  <p class="company-name pull-left text-uppercase bold no-margin">
                                    <span class="fa fa-circle text-primary fs-11"></span> มัธยมศึกษาตอนปลาย
                                  </p>
                                  <div class="clearfix"></div>
                                </div>
                    ...
                    <div class="card no-border  no-margin">
                      <div class="padding-15">
                        <div class="item-header clearfix">
                          <div class="thumbnail-wrapper d32 circular">
                            <img width="40" height="40" src="assets_admin/img/profiles/3x.jpg" data-src="assets_admin/img/profiles/3.jpg" data-src-retina="assets_admin/img/profiles/3x.jpg" alt="">
                          </div>
                      ...
                      <div class="relative">
                        ...
                        <div class="widget-19-post no-overflow">
                          <img src="assets_admin/img/social-post-image.png" class="block center-margin relative" alt="Post">
                        </div>
                      </div>
                      <div class="padding-15">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/1x.jpg" data-src="assets_admin/img/profiles/1.jpg" src="assets_admin/img/profiles/1x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/2x.jpg" data-src="assets_admin/img/profiles/2.jpg" src="assets_admin/img/profiles/2x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/3x.jpg" data-src="assets_admin/img/profiles/3.jpg" src="assets_admin/img/profiles/3x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/4x.jpg" data-src="assets_admin/img/profiles/4.jpg" src="assets_admin/img/profiles/4x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/5x.jpg" data-src="assets_admin/img/profiles/5.jpg" src="assets_admin/img/profiles/5x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/6x.jpg" data-src="assets_admin/img/profiles/6.jpg" src="assets_admin/img/profiles/6x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/7x.jpg" data-src="assets_admin/img/profiles/7.jpg" src="assets_admin/img/profiles/7x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/8x.jpg" data-src="assets_admin/img/profiles/8.jpg" src="assets_admin/img/profiles/8x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets_admin/img/profiles/9x.jpg" data-src="assets_admin/img/profiles/9.jpg" src="assets_admin/img/profiles/9x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="assets_admin/img/profiles/avatar_small.jpg" alt="" data-src="assets_admin/img/profiles/avatar_small.jpg" data-src-retina="assets_admin/img/profiles/avatar_small2x.jpg">
                  </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="assets_admin/img/logo.png" alt="logo" data-src="assets_admin/img/logo.png" data-src-retina="assets_admin/img/logo_2x.png" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="assets_admin/img/profiles/avatar.jpg" data-src="assets_admin/img/profiles/avatar.jpg" data-src-retina="assets_admin/img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>

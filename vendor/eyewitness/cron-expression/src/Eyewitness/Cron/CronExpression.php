...
class CronExpression
{
    ...
    public function setExpression($value)
    {
        ...
        $this->setPart(0, $this->cronParts[0]);
        $this->setPart(1, $this->cronParts[1]);
        $this->setPart(2, $this->cronParts[2]);
        $this->setPart(3, $this->cronParts[3]);
        $this->setPart(4, $this->cronParts[4]);
